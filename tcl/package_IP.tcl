...
# ---------------------------------------------------------------------
set Project_Name fifo_mig_based_ip
...
set_property display_name FIFO_MIG_Based [ipx::current_core]
set_property description FIFO_MIG_Based [ipx::current_core]
...
set_property display_name {PHY to USR Clock Rate} [ipgui::get_guiparamspec -name "PHY_to_UI_Rate" -component [ipx::current_core] ]
set_property tooltip {PHY to USR Clock Rate} [ipgui::get_guiparamspec -name "PHY_to_UI_Rate" -component [ipx::current_core] ]
set_property widget {comboBox} [ipgui::get_guiparamspec -name "PHY_to_UI_Rate" -component [ipx::current_core] ]
set_property value_validation_type pairs [ipx::get_user_parameters PHY_to_UI_Rate -of_objects [ipx::current_core]]
set_property value_validation_pairs {x2 2 x4 1} [ipx::get_user_parameters PHY_to_UI_Rate -of_objects [ipx::current_core]]

# размер памяти в словах Fifo
ipgui::move_param -component [ipx::current_core] -order 1 [ipgui::get_guiparamspec -name "Memory_Size" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
...
# начальный адрес
set_property tooltip {Base Address is multiple of 8} [ipgui::get_guiparamspec -name "Base_Address" -component [ipx::current_core] ]
...
# размер шины адреса MIG
set_property display_name {MIG Address Size} [ipgui::get_guiparamspec -name "MIG_Addr_Port_Size" -component [ipx::current_core] ]
set_property tooltip {MIG Address Size} [ipgui::get_guiparamspec -name "MIG_Addr_Port_Size" -component [ipx::current_core] ]
set_property widget {textEdit} [ipgui::get_guiparamspec -name "MIG_Addr_Port_Size" -component [ipx::current_core] ]

# размер шины данных MIG
set_property display_name {MIG Data Size} [ipgui::get_guiparamspec -name "MIG_Data_Port_Size" -component [ipx::current_core] ]
set_property tooltip {MIG Data Size} [ipgui::get_guiparamspec -name "MIG_Data_Port_Size" -component [ipx::current_core] ]
set_property widget {comboBox} [ipgui::get_guiparamspec -name "MIG_Data_Port_Size" -component [ipx::current_core] ]
set_property value_validation_type list [ipx::get_user_parameters MIG_Data_Port_Size -of_objects [ipx::current_core]]
set_property value_validation_list {32 64 128 256 512} [ipx::get_user_parameters MIG_Data_Port_Size -of_objects [ipx::current_core]]
...
ipgui::move_param -component [ipx::current_core] -order 0 [ipgui::get_guiparamspec -name "PHY_to_UI_Rate" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
