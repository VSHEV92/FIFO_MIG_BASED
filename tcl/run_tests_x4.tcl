# ------------------------------------------------------
# ----- Cкрипт для автоматического запуска тестов x4 ---
# ------------------------------------------------------
...
add_files -fileset sim_1 ./hdl/testbench/Fifo_MIG_Based_x4_tb.sv
...
file copy -force constraints/mig_a_x4.prj fifo_mig_based_tests/fifo_mig_based_tests.srcs/sources_1/ip/mig_7series_0/mig_a.prj 
