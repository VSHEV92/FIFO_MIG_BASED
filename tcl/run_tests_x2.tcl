...
# ----------------------------------------------------------------
# выбераем первый тестовый набор в качествре начального   
set Test_Set_Name ./hdl/header/test_sets/test_set_x2_1.svh
file copy -force $Test_Set_Name ./hdl/header/test_set.svh

# добавляем заголовочные файлы к проекту
add_files ./hdl/header/Environment.svh
add_files ./hdl/header/testbench_settings_x2.svh
...
add_files -fileset sim_1 ./hdl/testbench/Fifo_MIG_Based_x2_tb.sv
...
file copy -force constraints/mig_a_x2.prj fifo_mig_based_tests/fifo_mig_based_tests.srcs/sources_1/ip/mig_7series_0/mig_a.prj 
set_property -dict [list CONFIG.XML_INPUT_FILE {mig_a.prj}] [get_ips mig_7series_0]
generate_target {instantiation_template} [get_files fifo_mig_based_tests/fifo_mig_based_tests.srcs/sources_1/ip/mig_7series_0/mig_7series_0.xci]
generate_target {simulation} [get_files fifo_mig_based_tests/fifo_mig_based_tests.srcs/sources_1/ip/mig_7series_0/mig_7series_0.xci]
...
set fileID [open $Log_Dir_Name/Test_Results_x2.txt w]
close $fileID
set fileID [open $Log_Dir_Name/Test_Logs.txt a]
close $fileID
